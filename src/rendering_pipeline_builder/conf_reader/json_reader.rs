...
///
/// Design of public rendering pipeline configuration interface is
/// optimized for Nix and I DO NOT recommend to use JSON format.
///
/// Configuring rendering pipeline in JSON may cause readability,
/// maintainability, reusability and runtime cache efficiency issues.
